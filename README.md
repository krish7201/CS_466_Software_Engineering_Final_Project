...
### Specification (Functional and non-functional requirements)
  - Functional requirements: 
    ...
    - Management – Admins must be able to manage accounts and perform administrative tasks.
    - Features – Users must be able to use features such as a grade calculator and a scheduler.
      
  - Nonfunctional requirements:
    - Performance – The system must perform commands flawlessly and within time expectations such as no more than 2 milliseconds to calculate grades.
    - Security – The system must securely store all personal information and grades and encrypt this data to ensure privacy.
    - Scalability – The system must support an ever-growing user base starting with 5,000 concurrent users.
